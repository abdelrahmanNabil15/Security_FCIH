                ...
                <tr>
                 ...
                 if ($getCat) {
                  ...
                  <tr>
                    ...
                    <td>
                        <select id="select" name="sel_id">
                            <option>Select Seller</option>
                            <?php 
                            $sel = new Product();
                            $getsel = $sel->getAllseller();
                            if ($getsel) {
                                while ($result = $getsel->fetch_assoc()) {
                                    ?>
                            <option 
                            <?php 
                            if ($value['sel_id'] == $result['sel_id']) {
                                ?>
                                selected = "selected"
                            <?php
                            } ?>
                            value="<?php echo $result['	sel_id']; ?>"><?php echo $result['add_in']; ?></option>
                            <?php
                                }
                            } ?>
